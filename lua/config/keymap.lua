...
vim.keymap.set("n", "]f", "]gfzt", { silent = true, remap = true, desc = "goto: next function" })
vim.keymap.set("n", "[f", "[gfzt", { silent = true, remap = true, desc = "goto: prev function" })
vim.keymap.set("n", "]c", "]gczt", { silent = true, remap = true, desc = "goto: next class" })
vim.keymap.set("n", "[c", "[gczt", { silent = true, remap = true, desc = "goto: prev class" })
