...
vim.keymap.set("n", "<leader>e", function() vim.diagnostic.goto_next() vim.diagnostic.open_float(nil, { focus = false }) end, { desc = "Next diagnostic with float" })
vim.keymap.set("n", "<leader>E", function() vim.diagnostic.goto_prev() vim.diagnostic.open_float(nil, { focus = false }) end, { desc = "Previous diagnostic with float" })
