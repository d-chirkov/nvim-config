...
vim.keymap.set("n", "<c-s>", "<ESC>:tab split<cr>", { silent = true, noremap = true, desc = "tab: new" })
...
vim.keymap.set("n", "Z", "ZZ", { silent = true, noremap = true, desc = "document: close" })
...
vim.keymap.set({ "n", "v" }, "<c-h>", "^", { silent = true, noremap = true, desc = "goto: left" })
vim.keymap.set("i", "<c-h>", "<esc>^i", { silent = true, noremap = true, desc = "goto: left" })
vim.keymap.set({ "n", "v" }, "<c-l>", "$", { silent = true, noremap = true, desc = "goto: right" })
